...
/*!
 ...
 configure exception reporting, hook and unhook the exception handlers, and
 report and record exceptions.
...
/*!
 Uninstalls the Squash uncaught-exception handler and default signal handler.
 Squash will no longer record exceptions.
 */
- (oneway void) unhook;
